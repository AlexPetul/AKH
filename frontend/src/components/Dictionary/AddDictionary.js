...
class AddDictionary extends Component {
    constructor() {
        ...
        this.state = {
            ...
            maxWeight: new ValidationInput([new Rule(TypeOfRule.REQUIRED, "Введите пожалуйста максимальный вес")],
                true),
            nameRus: new ValidationInput([], true),
            nameEng: new ValidationInput([], true),
    ...
    submit = () => {
        ...
        if ((this.state.nameRus.value === "") && (this.state.nameEng.value === "")) {
            this.setState({
                errorModal: true,
                errorText: "Введите название на одном из языков."
            })
        } else {
        ...
        return (
            <div className="content">
                <div className="container">
                    <div className="form">
                        <form>
                            <div className="caption">Добавить позицию</div>
                ...
                <ModalWindow
                    textTitle="Типоразмер успешно добавлен!"
                    value="Ok"
